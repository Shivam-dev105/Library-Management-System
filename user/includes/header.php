...
// user data fetch 
$user = mysqli_query($con, "SELECT `name` FROM `users` WHERE `email`='$userEmail'");
...
<div class="d-flex align-items-center mb-4 bg-white p-3 rounded shadow sticky-top">
    ...
    <h4 class="fw-bold mb-0 d-none d-sm-block">Welcome, <?= $userRow['name']; ?></h4>

    <div class="dropdown ms-auto">
        <button class="btn bg-light border rounded-pill px-3 shadow-sm dropdown-toggle"
            type="button" data-bs-toggle="dropdown" aria-expanded="false">
            <i class="bi bi-person-circle text-primary me-1"></i> <?= $userRow['name']; ?>
        </button>
