...
<div class="sidebar" id="sidebar">
    <div class="px-4 mb-4 sidebar-header">
        <div class="sidebar-logo d-none">
            <img src="../admin/uploads/logo/<?= $settingRow['logo']; ?>" width="70" class="rounded-circle" alt="Logo">
        </div>
    ...
    <nav class="nav flex-column">
        ...
        <a class="nav-link <?php echo ($currentPage == 'search_books.php') ? 'active' : ''; ?>" href="search_books.php"><i class="bi bi-search"></i> <span>Search Books</span></a>
        <a class="nav-link <?php echo ($currentPage == 'my_issued_books.php') ? 'active' : ''; ?>" href="my_issued_books.php"><i class="bi bi-book"></i> <span>My Issued Books</span></a>
        ...
        <a class="nav-link <?php echo ($currentPage == 'fines.php') ? 'active' : ''; ?>" href="fines.php"><i class="bi bi-cash-coin"></i> <span>Pending Fines</span></a>

        <hr class="mx-3 opacity-25 text-white">

        <a class="nav-link <?php echo ($currentPage == 'profile.php') ? 'active' : ''; ?>" href="profile.php"><i class="bi bi-person-circle"></i> <span>My Profile</span></a>
